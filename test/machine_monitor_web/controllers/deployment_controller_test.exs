defmodule MachineMonitorWeb.DeploymentControllerTest do
  ...
  test "GET / returns machine deployments list", %{conn: conn, user: user, machine: %{name: name}} do
    conn = get(conn, deployment_path(conn, :list, name), %{p: 1, pp: 20})
